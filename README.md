...
| **SRBench 20** (E2E vs DeSTrOI+E2E) | 20 | E2E **7/20** R²≥0.99; Feynman 7/12; Strogatz 0/8; DeSTrOI acc **62.5%** (mapped, fair) on all-20; **61.5%** on expressible-16 | [CSV](results/srbench/srbench_20_benchmark.csv) · [summary](results/srbench/srbench_20_benchmark_summary.txt) · [re-analysis](reanalyze_srbench_20.py) · [docs §7](docs/LITERATURE_AND_RESULTS.md#7-our-experimental-results) |
