...
| **Phase A SRBench** (E2E vs DeSTrOI+E2E) | 20 | E2E **7/20** R²≥0.99; Feynman 7/12; Strogatz 0/8 | [A](results/srbench/phase_a_benchmark.csv) · [B](results/srbench/phase_a_benchmark_subset_10_b.csv) · [docs §9](docs/LITERATURE_AND_RESULTS.md#9-our-experimental-results) |
...
| **3** | Benchmark showdown (E2E ± DeSTrOI on SRBench) | ✅ Phase A done (10 problems) | [phase_a_benchmark.csv](results/srbench/phase_a_benchmark.csv) |
